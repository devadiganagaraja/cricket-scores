...
@Component
@Scope("prototype")
public class RefreshEventPlayerPointsTask implements Runnable{


    private static final Logger logger = LoggerFactory.getLogger(RefreshEventPlayerPointsTask.class);
